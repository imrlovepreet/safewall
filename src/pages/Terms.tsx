      ...
      <div className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose max-w-none">
            ...
            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">1. Definitions</h2>
            ...
            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">2. Eligibility & Acceptable Use</h2>
            <p className="text-brand-dark/70">To use our services, you must:</p>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <p className="text-brand-dark/70 mt-4">You agree not to:</p>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">3. Services Provided</h2>
            <p className="text-brand-dark/70">We offer IT and cybersecurity services, including but not limited to:</p>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4 font-montserrat">A. No Guarantee of Results</h3>
            <p className="text-brand-dark/70">
            ...
            <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4 font-montserrat">B. Service Modifications</h3>
            <p className="text-brand-dark/70">SafeWall reserves the right to:</p>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">4. Payment Terms & Billing</h2>
            <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4 font-montserrat">A. Pricing & Quotes</h3>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4 font-montserrat">B. Invoices & Late Payments</h3>
            <ul className="list-disc pl-6 text-brand-dark/70">
              <li>Payments are due as per the invoice terms.</li>
              <li>Late payments may result in service suspension or late fees.</li>
            </ul>

            <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4 font-montserrat">C. Refunds & Cancellations</h3>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">5. Confidentiality & Data Security</h2>
            <p className="text-brand-dark/70">
              We take data security seriously and follow Canadian privacy laws (PIPEDA) to protect your information.
            </p>

            <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4 font-montserrat">Client Confidentiality</h3>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4 font-montserrat">Data Protection Measures</h3>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h3 className="text-xl font-bold text-brand-dark mt-8 mb-4 font-montserrat">Third-Party Tools & Integrations</h3>
            <p className="text-brand-dark/70">
            ...
            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">6. Limitation of Liability</h2>
            <p className="text-brand-dark/70">SafeWall is not liable for:</p>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <p className="text-brand-dark/70 mt-4">Legal Disclaimer:</p>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">7. Termination of Services</h2>
            <p className="text-brand-dark/70">We reserve the right to suspend or terminate your access if:</p>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">8. Governing Law & Jurisdiction (Canadian Compliance)</h2>
            <p className="text-brand-dark/70">These Terms are governed by the laws of Canada, specifically:</p>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">9. Intellectual Property Rights</h2>
            <p className="text-brand-dark/70">SafeWall owns all intellectual property related to:</p>
            <ul className="list-disc pl-6 text-brand-dark/70">
            ...
            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">10. Changes to These Terms</h2>
            <ul className="list-disc pl-6 text-brand-dark/70">
              <li>We may update these Terms from time to time.</li>
              <li>Changes will be posted on our website, and your continued use indicates acceptance.</li>
            </ul>

            <h2 className="text-2xl font-bold text-brand-dark mt-12 mb-6 font-montserrat">11. Contact Information</h2>
            <p className="text-brand-dark/70">If you have any questions or concerns, contact us at:</p>
